...
import type { SessionRuntimeRow, SessionRuntimeStatus } from "@gitinspect/db/storage-types";

type SessionRuntimeUpdate = Partial<Omit<SessionRuntimeRow, "sessionId" | "updatedAt">>;
